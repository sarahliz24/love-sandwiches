'''
docsting for importing gspread module
'''
import gspread
...
def update_sales_worksheet(data):
    '''"""
    Update sames worksheet, add new row with the list data provided.
    '''
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as teh sames figure subtracted from the stock:
    - Positive surplus indicates waste
    - Negative surplus indicates extra made when stock was sold out.
    '''
    print("Calculating surplus data...\n")
    stock = SHEET.worksheet("stock").get_all_values()
    stock_row = stock[-1]  # slices last row from spreadsheet
...
def get_last_5_entries_sales():
    ...
    the alst 5 entries for each sandwich and returns the dat
    as a list of lists
    '''
